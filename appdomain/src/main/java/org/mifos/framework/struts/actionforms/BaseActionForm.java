...
public class BaseActionForm extends ValidatorActionForm {
    ...
    protected DoubleConversionResult parseFourDecimalForMoney(String doubleString, MifosCurrency currency) {
        LocalizationConverter localizationConverter;
        if (currency == null) {
            localizationConverter = new LocalizationConverter();
        } else {
        ...
        return localizationConverter.parseFourDecimalForMoneyFA(doubleString);
