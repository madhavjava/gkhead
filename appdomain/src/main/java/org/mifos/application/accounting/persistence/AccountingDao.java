...
public interface AccountingDao {
	...
	List<GLCodeDto> findAccountHeadExpenditureGlCodes(String glCode);
	...
	List<GLCodeDto> findinsuranceRelatedAccounts();
	List<GLCodeDto> findAccountHeadGlCodesAll(String glCode);
	List<GLCodeDto> findGlCodesAssetsAndLibialities();
	List<GLCodeDto> findAccountHeadGlCodesGK(String glCode);
