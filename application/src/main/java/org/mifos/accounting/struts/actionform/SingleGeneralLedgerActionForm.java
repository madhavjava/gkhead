...
public class SingleGeneralLedgerActionForm extends BaseActionForm {
	...
	private String insurenceRelated="No";

	private String officeLevelId;

	
	public String getInsurenceRelated() {
		return insurenceRelated;
	}

	public void setInsurenceRelated(String insurenceRelated) {
		this.insurenceRelated = insurenceRelated;
	}
	...
	private ActionErrors mandatoryCheck(UserContext userContext) {
		...
		//madhav
		if(getInsurenceRelated().equalsIgnoreCase("yes"))
	...
	protected DoubleConversionResult validateAmount(String amountString,
		...
		DoubleConversionResult conversionResult = parseFourDecimalForMoney(
