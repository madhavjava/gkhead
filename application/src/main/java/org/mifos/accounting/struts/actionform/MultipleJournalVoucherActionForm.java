...
public class MultipleJournalVoucherActionForm extends BaseActionForm {
	...
	private ActionErrors mandatoryCheck(UserContext userContext) {
		...
		String [] amounts123=this.getAmount();
		String [] accountHead123=getCreditAccountHead();
		String [] notes123=getVoucherNotes();
		...
		//String accounthead=accountHead123[i];
			...
			if (StringUtils.isNotBlank(amounts123[i])) {
				DoubleConversionResult conversionResult = validateAmount(
						amounts123[i], Amount, errors);
