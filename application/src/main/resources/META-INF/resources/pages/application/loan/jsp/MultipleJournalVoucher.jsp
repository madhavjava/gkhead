...
<html-el:form action="/multipleJournalvoucheraction.do">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<table width="93%" border="0" cellpadding="3" cellspacing="0">
										<tr>
											<td class="headingorange">
												...
												<mifos:mifoslabel name="simpleAccounting.multiplejvaction" />
			...
			<tr class="fontnormal">
				...
				<td align="left">
					  <html-el:text property="amount" styleClass="separatedNumber" styleId="applypayment.input.amount" name="multiplejournalvoucheractionform" />
				</td>
 ...
 <TABLE id="dataTable" width="350px" border="1" cellpadding="0" cellspacing="0">
        ...
        <TD><INPUT type="checkbox" name="chk"/></TD>
				<td align="left">
					<mifos:select property="creditAccountHead" >
				        <c:forEach items="${sessionScope.CreditAccounts}" var="accountHead" >
				...
				<td align="left">
					  <html-el:text property="amount" styleClass="separatedNumber" value="0" styleId="simpleaccounting.input.amount" onkeypress="return isNumberKey(event)"/>
				</td>


		 <td align="left" colspan="3">
		 <html-el:text property="voucherNotes" styleClass="separatedNumber" value=""  styleId="simpleaccounting.input.amount"/>
             </td>
        </TR>
    </TABLE>
