		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <input type="hidden" name="iPageNo" value="${ViewGlTransactionPaginaitonVariablesDto.iPageNo}">
			...
			<tr class="fontnormal" bgcolor="#F2A23A">
				...
				<th>Sub Account</th>
	            <th>Narration</th>
				<th>Cr Trans. Amount</th>
                 <th>Dr Trans. Amount</th>

			</tr>
		         <c:forEach items="${sessionScope.ViewTransactionsDtos}" var="viewTransactionsDtos">
		      <tr class="fontnormal">
<c:if test="${viewTransactionsDtos.amountAction=='credit'}"> 
			      ...
			      <td align="right"><fmt:formatNumber value="${viewTransactionsDtos.transactionAmount}"/></td>
                  <td align="right">${"--------"}</td>
				  	</c:if>
<c:if test="${viewTransactionsDtos.amountAction=='debit'}"> 
