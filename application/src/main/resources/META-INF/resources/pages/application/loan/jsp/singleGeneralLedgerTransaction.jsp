...
function fnloadOffices(form) {
	...
	form.action="singlegeneralledgeraction.do";
	form.submit();
}
...
function fncheckForInsurenceRelatedHeads(form) {
	form.method.value="checkForInsurenceRelatedHeads";
	form.action="singlegeneralledgeraction.do";
	form.submit();
}
...
function fnBankDetail(){
	...
	if(trxnType == 'BR' || trxnType == 'BP'){
		...
		$("#bankDetailsId").hide();
											...
											<body onload="fnBankDetail()">
												...
												<html-el:form action="/singlegeneralledgeraction.do">
 ...
 -->
																									...
																									<tr class="fontnormal">
																										...
																										<td align="left">
																											<mifos:select property="accountHead" onchange="fncheckForInsurenceRelatedHeads(this.form)">
